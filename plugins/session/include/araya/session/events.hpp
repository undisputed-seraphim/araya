...
inline constexpr araya::event_key<session_created_msg,
                                    araya::dispatch_mode::emit>
    created_key{"session/created", 1};

inline constexpr araya::event_key<session_disposed_msg,
                                    araya::dispatch_mode::emit>
    disposed_key{"session/disposed", 1};

inline constexpr araya::event_key<session_appended_msg,
                                    araya::dispatch_mode::emit>
    appended_key{"session/event", 1};

inline constexpr araya::event_key<session_flush_msg,
