...
std::unique_ptr<araya::plugin> make_validating_provider(
    araya::plugin_config const& cfg) {
...
std::unique_ptr<araya::plugin> make_slow(araya::plugin_config const&) {
...
static const araya::plugin_descriptor g_slow_desc{
...
static araya_instance_v1* make_native_mod(const araya_config_pair*,
                                            std::size_t) {
    auto* inst = new araya_instance_v1{};
    inst->apply = +[](araya_instance_v1* self, araya_fiber fiber,
...
static araya_plugin_descriptor_v1 g_native_desc{
    ARAYA_ABI_VERSION, "native", nullptr, 0, nullptr, 0, &make_native_mod};

extern "C" const araya_plugin_descriptor_v1* invariants_native_entry(
