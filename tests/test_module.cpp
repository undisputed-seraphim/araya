...
static void mod_apply(araya_instance_v1* self, araya_fiber fiber, void (*complete)(araya_fiber, int, const char*)) {
	...
	if (g_host->provide(
			fiber, "example.db", 1, db, +[](void* p) { delete static_cast<db_value*>(p); }, nullptr) != ARAYA_ABI_OK) {
...
static const araya_plugin_descriptor_v1 g_desc{ARAYA_ABI_VERSION, "dlopen-module", nullptr, 0, g_provide, 1, &make_mod};
